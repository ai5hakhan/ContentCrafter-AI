...
function Billing() {
  ...
  const SaveSubscription = async (paymentId: string) => {
    ...
    .values({
        ...
        active: true,
        paymentId: paymentId,
        joinDate: new Date().toLocaleDateString(), // Using JS date formatting
      });
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center">
          ...
          <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-lg">
            <div className="text-center">
              <h2 className="text-lg font-medium text-gray-900">Free
              
                
                <span className="sr-only">Plan
                  
                </span>
              </h2>
              <p className="mt-2 sm:mt-4">
                <strong className="text-3xl font-bold text-gray-900">Rs.0</strong>
            ...
            href="#"
              ...
              hover:ring-1 hover:ring-indigo-600 focus:outline-none  focus"
          ...
          <div className="rounded-2xl bg-white border border-gray-200 p-6 shadow-lg">
            <div className="text-center">
              ...
              <p className="mt-2 sm:mt-4">
                <strong className="text-3xl font-bold text-gray-900">Rs.500</strong>
            ...
            <button
              ...
              className="mt-8 w-full flex gap-2 text-center items-center bg-blue-500 text-white font-semibold py-2 px-4 rounded hover:bg-blue-600"
            >
